export declare class ColorService {
    ...
    static bgBlue: (text?: string) => any;
    static bgBrightBlue: (text?: string) => any;
    static bgCyan: (text?: string) => any;
